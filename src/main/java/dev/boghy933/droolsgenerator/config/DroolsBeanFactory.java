package dev.boghy933.droolsgenerator.config;
...
public class DroolsBeanFactory {
    ...
    private  KieFileSystem getKieFileSystem() throws IOException{
        ...
        List<String> rules=Arrays.asList("test.drl");
    ...
    public KieSession getKieSession(){
        ...
        kieFileSystem.write(ResourceFactory.newClassPathResource("generated/test.drl"));
